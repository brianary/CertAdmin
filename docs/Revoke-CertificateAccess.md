...
### Example 1
```powershell
PS C:\> Revoke-CertificateAccess -AppPool ExampleAppPool -Certificate $cert
```
...
### Example 2
```powershell
PS C:\> Find-Certificate -FindValue ExampleCert -FindType FindBySubjectName -StoreName TrustedPeople -StoreLocation LocalMachine |Revoke-CertificateAccess ExampleAppPool
```
